(define (problem workshop2_2_4_4_1) (:domain workshop)
(:objects
	r0n0 - room
	r0n1 - room
	r0n2 - room
...
(:init
	...
	(adjacent r2n1 r2n3 d6)
	(adjacent r2n3 r2n1 d6)
	(adjacent r2n3 r2n0 d7)
	(adjacent r2n0 r2n3 d7)
	(adjacent r2n3 r2n2 d8)
	(adjacent r2n2 r2n3 d8)
	(adjacent r3n2 r3n1 d9)
	(adjacent r3n1 r3n2 d9)
	(adjacent r3n1 r3n3 d10)
	(adjacent r3n3 r3n1 d10)
	(adjacent r3n1 r3n0 d11)
	(adjacent r3n0 r3n1 d11)
	(adjacent r2n3 r3n1 d12)
	(adjacent r3n1 r2n3 d12)
	(adjacent r3n3 r0n0 d13)
	(adjacent r0n0 r3n3 d13)
	(adjacent r3n3 r1n0 d14)
	(adjacent r1n0 r3n3 d14)
	(unlocked d0)
	(unlocked d1)
	(unlocked d2)
	(unlocked d3)
